...
MASTER_VENDORS = [
    {"vendor_name": "Walmart", "aliases": "WALMART #4521, Walmart Inc"},
    {"vendor_name": "Acme Supplies", "aliases": ""},
]
...
def test_duplicate_invoice_number_flags_for_review():
    existing_rows = [
        {"vendor": "Acme Supplies", "invoice_number": "INV-500", "invoice_date": "2026-08-01", "total": 54.0},
    ]
    record = {
...
def test_duplicate_without_invoice_number_matches_on_date_and_total():
    existing_rows = [
        {"vendor": "Walmart", "invoice_number": "", "invoice_date": "2026-08-01", "total": 16.2},
    ]
    record = {
        "vendor": "Walmart",
